...
class DETRHead_Nuclei(BaseModule):
    ...
    def __init__(
            ...
            loss_cls: ConfigType = dict(
                ...
                loss_weight=1.0,
                class_weight=1.0),
            loss_point: ConfigType = dict(type='L1Loss', loss_weight=5.0),
        ...
        if class_weight is not None and (self.__class__ is DETRHead_Nuclei):
    ...
    def loss_by_feat(
        ...
        **kwargs,
        ...
        for loss_cls_i, loss_bbox_i in \
            ...
            loss_dict[f'd{num_dec_layer}.loss_point'] = loss_bbox_i
            num_dec_layer += 1
        return loss_dict
    ...
    def get_targets(self, cls_scores_list: List[Tensor],
        ...
        (labels_list, label_weights_list, point_targets_list, point_weights_list,
         ...
         neg_inds_list) = multi_apply(self._get_targets_single,
                                      cls_scores_list, point_preds_list,
                                      batch_gt_instances, batch_img_metas, **kwargs)
    ...
    def _predict_by_feat_single(self,
        ...
        if self.loss_cls.use_sigmoid:
            ...
            point_index = torch.div(indexes, self.num_classes, rounding_mode='floor')
