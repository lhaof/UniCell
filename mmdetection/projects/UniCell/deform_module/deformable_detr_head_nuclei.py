...
from .detr_head_nuclei import DETRHead_Nuclei


@MODELS.register_module()
class DeformableDETRHead_Nuclei(DETRHead_Nuclei):
        ...
        if enc_cls_scores is not None:
            ...
            enc_loss_cls, enc_losses_point = \
                self.loss_by_feat_single(
                    enc_cls_scores, enc_point_preds,
                    batch_gt_instances=proposal_gt_instances,
                    batch_img_metas=batch_img_metas, **kwargs)
            loss_dict['enc_loss_cls'] = enc_loss_cls
            loss_dict['enc_loss_point'] = enc_losses_point
        return loss_dict
